...
var _elm_lang$elm_architecture_tutorial$Config$config = {
	vehicle: {x: 28, y: 15},
	gravity: 1.5,
	engine: 2.2,
	thrusters: 2,
	backgroundColor: '#9DACC9',
	base: {color: '#202692', y: 5},
	pad: {color: '#808080', x: 30, y: 3},
	correction: {theta: 2, dx: 1.1},
	coin: {x: 4, y: 9},
	debris: {x: 40, y: 20}
};
var _elm_lang$elm_architecture_tutorial$Config$Config = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {vehicle: a, gravity: b, engine: c, thrusters: d, backgroundColor: e, base: f, pad: g, correction: h, coin: i, debris: j};
									};
								};
							};
						};
...
var _elm_lang$elm_architecture_tutorial$Utils$floatModulo = F2(
	function (number, modulo) {
		floatModulo:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(number, modulo) > 0) {
				var _v0 = number - modulo,
					_v1 = modulo;
				number = _v0;
				modulo = _v1;
				continue floatModulo;
			} else {
				if (_elm_lang$core$Native_Utils.cmp(number, 0) < 0) {
					var _v2 = number + modulo,
						_v3 = modulo;
					number = _v2;
					modulo = _v3;
					continue floatModulo;
...
var _elm_lang$elm_architecture_tutorial$Model$coinCollected = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.goal, _elm_lang$elm_architecture_tutorial$Model$Pad) ? false : ((_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$Basics$abs(model.x - model.coin.x),
		_elm_lang$elm_architecture_tutorial$Config$config.vehicle.x / 2) > 0) ? false : ((_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$Basics$abs(model.y - model.coin.y),
		_elm_lang$elm_architecture_tutorial$Config$config.vehicle.y) > 0) ? false : true));
};
var _elm_lang$elm_architecture_tutorial$Model$coin = function (model) {
	return _elm_lang$elm_architecture_tutorial$Model$coinCollected(model) ? _elm_lang$core$Native_Utils.update(
		model,
		{
			coin: {
				x: A2(_elm_lang$elm_architecture_tutorial$Utils$floatModulo, model.coin.x + 71, 200),
				y: A3(
					_elm_lang$core$Basics$clamp,
					_elm_lang$elm_architecture_tutorial$Config$config.base.y + _elm_lang$elm_architecture_tutorial$Config$config.coin.y,
					100,
					A2(_elm_lang$elm_architecture_tutorial$Utils$floatModulo, model.coin.y + 39, 100))
			},
			score: model.score + 100,
			goal: _elm_lang$elm_architecture_tutorial$Model$Pad
		}) : model;
};
...
var _elm_lang$elm_architecture_tutorial$Model$vehicle = function (model) {
	...
	var intervalLength = model.intervalLengthMs / 100;
	var dyEngine = model.mainEngine ? ((_elm_lang$elm_architecture_tutorial$Config$config.engine * intervalLength) * _elm_lang$core$Basics$cos(thetaRad)) : 0;
	var dxEngine = model.mainEngine ? ((_elm_lang$elm_architecture_tutorial$Config$config.engine * intervalLength) * _elm_lang$core$Basics$sin(thetaRad)) : 0;
	var dx1 = _elm_lang$core$Native_Utils.eq(model.state, _elm_lang$elm_architecture_tutorial$Model$Flying) ? (model.dx + dxEngine) : (model.dx / _elm_lang$elm_architecture_tutorial$Config$config.correction.dx);
	var dy1 = (_elm_lang$core$Native_Utils.eq(model.state, _elm_lang$elm_architecture_tutorial$Model$Flying) ? (model.dy - (_elm_lang$elm_architecture_tutorial$Config$config.gravity * intervalLength)) : 0) + dyEngine;
		...
		default:
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					...
					dtheta: dtheta1,
					theta: theta1,
					debris: {show: false, x: 0, y: 0}
				});
	}
};
var _elm_lang$elm_architecture_tutorial$Model$goal = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.state, _elm_lang$elm_architecture_tutorial$Model$Crashed) ? _elm_lang$core$Native_Utils.update(
		model,
		{goal: _elm_lang$elm_architecture_tutorial$Model$Coin}) : ((_elm_lang$core$Native_Utils.eq(model.state, _elm_lang$elm_architecture_tutorial$Model$Landed) && (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$Basics$abs(model.dx),
		0.5) < 0)) ? _elm_lang$core$Native_Utils.update(
		model,
...
var _elm_lang$elm_architecture_tutorial$View$vehicle = function (model) {
	...
	var leftX = _elm_lang$core$Basics$toString(model.x - (_elm_lang$elm_architecture_tutorial$Config$config.vehicle.x / 2));
	var rotateY = _elm_lang$core$Basics$toString(100 - model.y);
	var vehicleTransform = A2(
		_elm_lang$core$Basics_ops['++'],
		'rotate(',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(model.theta),
			A2(
				_elm_lang$core$Basics_ops['++'],
				' ',
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						' ',
						A2(_elm_lang$core$Basics_ops['++'], rotateY, ')'))))));
	return A2(
		_elm_lang$svg$Svg$use,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$xlinkHref(
				A2(_elm_lang$core$Basics_ops['++'], 'graphics/helicopter.svg#', svgId)),
				_elm_lang$svg$Svg_Attributes$x(leftX),
				_elm_lang$svg$Svg_Attributes$y(topY),
				_elm_lang$svg$Svg_Attributes$transform(vehicleTransform)
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _elm_lang$elm_architecture_tutorial$View$debris = function (model) {
	return model.debris.show ? A2(
		_elm_lang$svg$Svg$use,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$xlinkHref('graphics/debris.svg#debris'),
				_elm_lang$svg$Svg_Attributes$x(
				_elm_lang$core$Basics$toString(model.debris.x - (_elm_lang$elm_architecture_tutorial$Config$config.debris.x / 2))),
				_elm_lang$svg$Svg_Attributes$y(
				_elm_lang$core$Basics$toString((100 - model.debris.y) - (_elm_lang$elm_architecture_tutorial$Config$config.debris.y / 2)))
			]),
		_elm_lang$core$Native_List.fromArray(
			[])) : _elm_lang$svg$Svg$text('');
};
var _elm_lang$elm_architecture_tutorial$View$base = function (model) {
	var vehicleWidth = _elm_lang$elm_architecture_tutorial$Config$config.vehicle.x * _elm_lang$core$Basics$cos(
		_elm_lang$core$Basics$degrees(model.theta));
	var baseY = 100 - _elm_lang$elm_architecture_tutorial$Config$config.base.y;
	return A2(
		_elm_lang$svg$Svg$g,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$svg$Svg_Attributes$y1('100'),
						_elm_lang$svg$Svg_Attributes$x2('200'),
						_elm_lang$svg$Svg_Attributes$y2('100'),
						_elm_lang$svg$Svg_Attributes$stroke(_elm_lang$elm_architecture_tutorial$Config$config.base.color),
						_elm_lang$svg$Svg_Attributes$strokeWidth(
						_elm_lang$core$Basics$toString(_elm_lang$elm_architecture_tutorial$Config$config.base.y * 2))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Basics$toString(baseY + 0.5)),
						_elm_lang$svg$Svg_Attributes$x2(
						_elm_lang$core$Basics$toString(50 + _elm_lang$elm_architecture_tutorial$Config$config.pad.x)),
						_elm_lang$svg$Svg_Attributes$y2(
						_elm_lang$core$Basics$toString(baseY + 0.5)),
						_elm_lang$svg$Svg_Attributes$stroke(_elm_lang$elm_architecture_tutorial$Config$config.pad.color),
						_elm_lang$svg$Svg_Attributes$strokeWidth(
						_elm_lang$core$Basics$toString(_elm_lang$elm_architecture_tutorial$Config$config.pad.y))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Basics$toString(model.x - (vehicleWidth / 2))),
						_elm_lang$svg$Svg_Attributes$y1(
						_elm_lang$core$Basics$toString(baseY + 0.5)),
						_elm_lang$svg$Svg_Attributes$x2(
						_elm_lang$core$Basics$toString(model.x + (vehicleWidth / 2))),
						...
						_elm_lang$svg$Svg_Attributes$opacity('0.4'),
...
var _elm_lang$elm_architecture_tutorial$View$coin = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.goal, _elm_lang$elm_architecture_tutorial$Model$Coin) ? A2(
		_elm_lang$svg$Svg$use,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$xlinkHref('graphics/coin.svg#coin'),
				_elm_lang$svg$Svg_Attributes$x(
				_elm_lang$core$Basics$toString(model.coin.x - (_elm_lang$elm_architecture_tutorial$Config$config.coin.x / 2))),
				_elm_lang$svg$Svg_Attributes$y(
				_elm_lang$core$Basics$toString((100 - model.coin.y) - (_elm_lang$elm_architecture_tutorial$Config$config.coin.y / 2)))
			]),
		_elm_lang$core$Native_List.fromArray(
			[])) : _elm_lang$svg$Svg$text('');
};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg$text('© 2016 chris bolin')
							]))
					]))
			])) : _elm_lang$svg$Svg$text('');
};
var _elm_lang$elm_architecture_tutorial$View$game = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$elm_architecture_tutorial$View$coin(model),
				_elm_lang$elm_architecture_tutorial$View$base(model),
...
var _elm_lang$elm_architecture_tutorial$View$view = function (model) {
	var fontImport = A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('@import \'https://fonts.googleapis.com/css?family=VT323')
			]));
	var mainStyle = _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
...
var _elm_lang$elm_architecture_tutorial$Update$init = {ctor: '_Tuple2', _0: _elm_lang$elm_architecture_tutorial$Model$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
		...
		switch (_p0.ctor) {
			...
			default:
				...
				switch (_p2) {
					...
					case 82:
						return _elm_lang$elm_architecture_tutorial$Update$init;
					default:
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
		}
...
var _elm_lang$elm_architecture_tutorial$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			subscriptions: _elm_lang$elm_architecture_tutorial$Subscriptions$subscriptions,
			view: _elm_lang$elm_architecture_tutorial$View$view,
			update: _elm_lang$elm_architecture_tutorial$Update$update,
			init: {ctor: '_Tuple2', _0: _elm_lang$elm_architecture_tutorial$Model$initialModel, _1: _elm_lang$core$Platform_Cmd$none}
		})
};
